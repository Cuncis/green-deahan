        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div
                ...
                <div class="p-6">
                    ...
                    <p class="text-stone-500 text-sm leading-relaxed mb-4">
                        Konstruksi lapangan futsal standar internasional. Pilih lantai <strong>interlock</strong> (awet
                        & hemat) atau <strong>rumput sintetis</strong> (nyaman & estetik). Sudah termasuk pencahayaan,
                        pagar, gawang, net, dan fasilitas pendukung lengkap.
                    </p>
                    <ul class="text-sm text-stone-600 space-y-1.5 mb-5">
                        ...
                        <li class="flex items-center gap-2"><span class="text-[#006400] font-bold">✓</span> Ruang ganti
                            & tribun (opsional)</li>
                    ...
                    <a href="https://wa.me/6281357570064?text=Halo,%20saya%20ingin%20konsultasi%20pembuatan%20lapangan%20futsal"
                        target="_blank"
                        class="block text-center bg-[#006400] text-white font-bold py-3 rounded-xl hover:bg-[#004d00] transition-colors text-sm">
                        Tanya Harga Futsal →
                    </a>
                </div>
            </div>
            ...
            <div class="reveal bg-white rounded-2xl border border-stone-200 overflow-hidden hover:shadow-xl hover:border-[#006400] transition-all group"
                ...
                <div class="p-6">
                    ...
                    <p class="text-stone-500 text-sm leading-relaxed mb-4">
                        Lapangan mini soccer dengan rumput sintetis premium grade A. Cocok untuk bisnis rental outdoor.
                        Sistem drainase profesional agar tidak tergenang saat hujan. Material bisa disesuaikan dengan
                        <strong>budget Anda</strong>.
                    </p>
                    <ul class="text-sm text-stone-600 space-y-1.5 mb-5">
                        ...
                        <li class="flex items-center gap-2"><span class="text-[#006400] font-bold">✓</span> Pencahayaan
                            malam hari (opsional)</li>
            ...
            <div class="reveal bg-white rounded-2xl border border-stone-200 overflow-hidden hover:shadow-xl hover:border-[#006400] transition-all group"
                ...
                <div class="p-6">
                    ...
                    <ul class="text-sm text-stone-600 space-y-1.5 mb-5">
                        <li class="flex items-center gap-2"><span class="text-[#006400] font-bold">✓</span> Rangka baja
                            galvanis anti karat</li>
                        <li class="flex items-center gap-2"><span class="text-[#006400] font-bold">✓</span> Kaca
                            tempered safety glass</li>
                        <li class="flex items-center gap-2"><span class="text-[#006400] font-bold">✓</span> Artificial
                            grass khusus padel</li>
                        <li class="flex items-center gap-2"><span class="text-[#006400] font-bold">✓</span> Standar
                            internasional IFF</li>
                        <li class="flex items-center gap-2"><span class="text-[#006400] font-bold">✓</span> Bisa indoor
                            & outdoor</li>
                    </ul>
            ...
            <div class="reveal bg-white rounded-2xl border border-stone-200 overflow-hidden hover:shadow-xl hover:border-[#006400] transition-all group"
                ...
                <div class="p-6">
                    ...
                    <ul class="text-sm text-stone-600 space-y-1.5 mb-5">
                        ...
                        <li class="flex items-center gap-2"><span class="text-[#006400] font-bold">✓</span> Pencahayaan
                            LED anti-silau</li>
                        <li class="flex items-center gap-2"><span class="text-[#006400] font-bold">✓</span> Tiang net &
                            net standar BWF</li>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="text-center mb-14 reveal">
                <span
                    ...
                    Kerja</span>
                <h2 class="font-display text-3xl md:text-4xl font-black text-stone-900 mb-3">Proses Mudah, Anda Cukup
                    Duduk Santai</h2>
                <p class="text-stone-500 max-w-xl mx-auto text-sm">Kami handle semua proses dari awal sampai lapangan
                    siap beroperasi. Transparansi penuh di setiap tahap.</p>
            </div>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div class="reveal text-center bg-[#006400] rounded-2xl p-6 text-white" style="transition-delay:.32s">
                    <div
        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center text-white">
                ...
                <div class="reveal" style="transition-delay:.2s">
                    ...
                    <div class="text-green-300 text-xs font-bold uppercase tracking-widest">+ Kota di Indonesia</div>
                </div>
                <div class="reveal" style="transition-delay:.3s">
                    <div class="font-display font-black text-5xl mb-1">24/7</div>
                    <div class="text-green-300 text-xs font-bold uppercase tracking-widest">Support & Konsultasi</div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div class="reveal rounded-2xl overflow-hidden border border-stone-200 group hover:shadow-lg transition-all"
                ...
                <div class="bg-white p-4">
                    ...
                    <p class="text-xs text-stone-500 mt-1">Lantai vinyl sport, LED anti-silau. 4 court dalam 1 gedung.
                    </p>
                </div>
            </div>
            <div class="reveal rounded-2xl overflow-hidden border border-stone-200 group hover:shadow-lg transition-all"
                ...
                <div class="bg-white p-4">
                    ...
                    <p class="text-xs text-stone-500 mt-1">Rumput sintetis tahan cuaca, sistem drainase anti banjir.</p>
                </div>
            </div>
            <div class="reveal rounded-2xl overflow-hidden border border-stone-200 group hover:shadow-lg transition-all"
                style="transition-delay:.24s">
                ...
                <div class="bg-white p-4">
                    ...
                    <p class="text-xs text-stone-500 mt-1">Full roof + pencahayaan. Bisa dipakai malam hari non-stop.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 gap-14 items-center">
                <div class="reveal">
                    <span
                        ...
                        Pilih Kami?</span>
                    <h2 class="font-display text-3xl md:text-4xl font-black text-stone-900 mb-8">
                        Dipercaya Ratusan Pemilik<br>Bisnis Lapangan di Indonesia
                    </h2>
                    <div class="space-y-4">
                        <div
    ...
    <section class="py-20 px-6 max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            <div class="reveal bg-white border border-stone-200 rounded-2xl p-6 hover:shadow-lg transition-shadow">
                ...
                <div class="flex items-center gap-3 pt-4 border-t border-stone-100">
                    <div class="img-ph w-11 h-11 rounded-full flex-shrink-0">
                        <div class="img-ph-text" style="font-size:.55rem; padding:.2rem; border:none; background:none;">
                            📸</div>
                    </div>
                    <div>
            ...
            <div class="reveal bg-white border border-stone-200 rounded-2xl p-6 hover:shadow-lg transition-shadow"
                ...
                <div class="flex text-yellow-400 text-lg mb-4">⭐⭐⭐⭐⭐</div>
                <p class="text-stone-700 text-sm leading-relaxed mb-5 italic">
                    "Tim yang sangat responsif! Konsultasi gratisnya detail banget, bantu pilih material sesuai budget.
                    Pengerjaan cepat dan rapi. Lapangan mini soccer saya jadi yang paling ramai di daerah. Recommended
                    100%!"
                </p>
                <div class="flex items-center gap-3 pt-4 border-t border-stone-100">
                    <div class="img-ph w-11 h-11 rounded-full flex-shrink-0">
            ...
            <div class="reveal bg-white border border-stone-200 rounded-2xl p-6 hover:shadow-lg transition-shadow"
                ...
                <div class="flex text-yellow-400 text-lg mb-4">⭐⭐⭐⭐⭐</div>
                <p class="text-stone-700 text-sm leading-relaxed mb-5 italic">
                    "Proyek lapangan padel pertama di kota kami dikerjakan GreenDeahan. Dari desain sampai konstruksi
                    standar internasional. Garansi dan after sales service-nya juga top. Puas banget, sudah
        ...
        <div class="max-w-3xl mx-auto">
            <div class="text-center mb-12 reveal">
                ...
                <h2 class="font-display text-3xl md:text-4xl font-black text-stone-900 mb-2">Pertanyaan yang Sering
                    Ditanyakan</h2>
                <p class="text-stone-500 text-sm">Tidak menemukan jawaban yang Anda cari? <a
                        href="https://wa.me/6281357570064" class="text-[#006400] font-semibold underline">Tanya langsung
                        via WhatsApp.</a></p>
            </div>
            ...
            <div class="space-y-3 reveal">
                <div class="faq-item bg-[#f7f5f2] border border-stone-200 rounded-xl overflow-hidden">
                    <button onclick="toggleFaq(this)"
                        ...
                        Apakah GreenDeahan mengerjakan proyek dari nol?
                ...
                <div class="faq-item bg-[#f7f5f2] border border-stone-200 rounded-xl overflow-hidden">
                    <button onclick="toggleFaq(this)"
                        class="w-full text-left p-5 font-semibold text-stone-900 flex justify-between items-center text-sm">
                        Lantai apa saja yang tersedia dan apa bedanya?
                        <span class="faq-icon text-[#006400] text-lg font-black transition-transform">+</span>
                    </button>
                    <div class="faq-answer px-5 text-sm text-stone-600 leading-relaxed">
                        <div class="pb-5">Kami menyediakan: <strong>Lantai Interlock</strong> — awet, mudah diperbaiki
                            jika rusak sebagian, cocok indoor, harga lebih terjangkau. <strong>Rumput Sintetis</strong>
                            — estetik, nyaman untuk outdoor, tahan cuaca. <strong>Vinyl Sport</strong> — khusus
                            badminton/indoor, non-slip dan ramah lutut. <strong>Artificial Grass Padel</strong> — khusus
                            lapangan padel standar internasional. Tim kami bantu pilih yang paling sesuai budget dan
                            kebutuhan Anda.</div>
                    </div>
                </div>
                <div class="faq-item bg-[#f7f5f2] border border-stone-200 rounded-xl overflow-hidden">
                    <button onclick="toggleFaq(this)"
                        class="w-full text-left p-5 font-semibold text-stone-900 flex justify-between items-center text-sm">
                        Berapa lama waktu pengerjaan konstruksi lapangan?
                        <span class="faq-icon text-[#006400] text-lg font-black transition-transform">+</span>
                    </button>
                    <div class="faq-answer px-5 text-sm text-stone-600 leading-relaxed">
                ...
                <div class="faq-item bg-[#f7f5f2] border border-stone-200 rounded-xl overflow-hidden">
                    <button onclick="toggleFaq(this)"
                        class="w-full text-left p-5 font-semibold text-stone-900 flex justify-between items-center text-sm">
                        Apakah ada garansi setelah lapangan selesai?
                        <span class="faq-icon text-[#006400] text-lg font-black transition-transform">+</span>
                    </button>
                    <div class="faq-answer px-5 text-sm text-stone-600 leading-relaxed">
                        <div class="pb-5">Ya, semua proyek dilengkapi garansi resmi untuk konstruksi dan material. Jika
                            ada kerusakan atau masalah akibat pengerjaan, tim kami akan datang dan memperbaiki tanpa
                            biaya tambahan. Detail garansi tertulis jelas di kontrak perjanjian.</div>
                    </div>
                </div>
                <div class="faq-item bg-[#f7f5f2] border border-stone-200 rounded-xl overflow-hidden">
                    <button onclick="toggleFaq(this)"
                ...
                <div class="faq-item bg-[#f7f5f2] border border-stone-200 rounded-xl overflow-hidden">
                    <button onclick="toggleFaq(this)"
                        class="w-full text-left p-5 font-semibold text-stone-900 flex justify-between items-center text-sm">
                        Apakah melayani daerah luar Jawa?
                        <span class="faq-icon text-[#006400] text-lg font-black transition-transform">+</span>
                    </button>
                    <div class="faq-answer px-5 text-sm text-stone-600 leading-relaxed">
            ...
            <div class="reveal">
                <div class="img-ph rounded-2xl w-full aspect-[4/3] border border-stone-200">
                    <div class="img-ph-text">📸 FOTO KANTOR / WORKSHOP<br>Tampak Luar Kantor atau Tim
                        Meeting<br>(Disarankan: 600×450px)</div>
                </div>
            </div>
            <div class="reveal">
                <span
                ...
                <p class="text-stone-600 text-sm leading-relaxed mb-4">
                    Green Deahan adalah jasa pembuatan lapangan olahraga profesional yang melayani seluruh Indonesia
                    sejak tahun 2010. Dengan pengalaman lebih dari <strong>16 tahun</strong>, kami spesialis dalam
                ...
                <div class="bg-[#f7f5f2] border border-stone-200 rounded-xl p-4 text-sm text-stone-600">
                    ...
                    <p>📞 <a href="tel:+6281357570064" class="text-[#006400] font-semibold">+62 813-5757-0064</a></p>
